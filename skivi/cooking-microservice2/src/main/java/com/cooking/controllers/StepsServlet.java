...
import com.cooking.models.article.stepsresources.StepResource;
import com.cooking.models.article.stepsresources.StepResourceRepositoryHibernate;
import com.cooking.models.sections.Section;
import com.cooking.models.sections.SectionHibernateRepository;
import com.cooking.utils.async.NotificationPublisher;
        ...
        try {
            ...
            if (path.matches(RESOURCE_PATH)) {
                ...
                try {
                     ...
                     * catre un queue
                     */
                    notificationPublisher.publish("cooking.step.update", "A new step has been added in cooking: " + step.getStepHeader());
                    notificationPublisher.publish("cooking.push.update", "A new step has been added in cooking: " + step.getStepHeader());
                } catch (DuplicateResourceException duplicateResourceException) {
                    response.sendError(HttpServletResponse.SC_CONFLICT);
                    return;
